#
#  Be sure to run `pod spec lint Scanner.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "Scanner app will used as subproject"

  spec.homepage     = "https://github.com/hassanrazakhalid/Scanner.git"
  ...
  spec.author             = { "Hassan Raza Khalid" => "hassanrazakhalid@yahoo..com" }
  # Or just: spec.author    = "Hassan Raza Khalid"
  # spec.authors            = { "Hassan Raza Khalid" => "hassanrazakhalid@yahoo..com" }
  # spec.social_media_url   = "https://twitter.com/Hassan Raza Khalid"
